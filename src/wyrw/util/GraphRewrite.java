...
/**
 * <p>
 * Represents a more complex form of rewrite which always corresponds to a
 * "graph". To do this, previously seen states are cached so that generated
 * states can be compared to see whether they correspond to those seen before.
 * This strategy is important in systems which are non-confluent to ensure
 * branches which loop will terminate (as they correspond to cycles in the
 * graph).
 * </p>
 * 
